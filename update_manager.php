...
$sql=mysqli_query($conn,"UPDATE manager SET first_name='$fname', last_name='$lname', staff_id='$sid',postal_address='$postal',phone='$phone',email='$email',username='$username', password='$pas' WHERE username='$username'");
...
<div id="footer" align="Center"> Pharmacy System App on Intranet System Development CourseWord 2020. Developed by Michael Ife</div>
</div>
</body>
</html>
